...
export default async function Likes({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      ...
      <div className="mb-12 mt-14 h-[calc(100vh-100px)] px-2 py-4 md:mb-0 md:mt-0 md:h-[calc(100vh)] md:px-4 md:py-6">
        <div className="mb-6 hidden px-2 text-3xl font-medium md:block">
          Likes
        </div>
        <div className="flex flex-wrap justify-between gap-4 md:mb-0 md:mt-0 md:justify-start">
          {likes.map((like) => (
