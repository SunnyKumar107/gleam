...
const post = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <>
      <Header type="post" />
      <div className="mb-12 mt-14 flex h-[calc(100vh-100px)] flex-col items-center pt-2 md:mb-0 md:mt-0 md:h-full md:p-4 lg:flex-row lg:items-start lg:justify-center lg:space-x-4">
        <Post post={post!} />
